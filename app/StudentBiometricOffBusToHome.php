...
class StudentBiometricOffBusToHome extends Model
{
    use Notifiable;
    ...
    protected $table = 'students_biometric_off_bus_to_home';
    protected $primaryKey = 'off_bus_to_home_number';

    protected $fillable = ['off_bus_to_home_number', 'student_no', 'date', 'time'];
    ...
    public static function markAttendance($id) {
        ...
        SMSController::sendSMS($parent->mobile_no, 'Notification from Christ_light international school. Your child is off the bus to home.');
