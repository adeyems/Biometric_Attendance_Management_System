        ...
        <div class="row justify-content-center"
            ...
            <div class="col-md-12">
                ...
                <div class="links title m-b-md offset-4 align-content-center">
                    <a href="{{ route('login.student') }}" style="margin-right: 50px;" class="btn btn-primary">Student</a>
                    <a href="{{ route('login.parent') }}" class="btn btn-primary" style="margin-right: 50px;">Parent</a>
