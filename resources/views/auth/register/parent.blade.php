                    ...
                    <div class="card-body">
                        <form method="POST" action="{{ route('createParent') }}">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <input id="mobile-no" type="tel" class="form-control @error('mobile_no') is-invalid @enderror" name="mobile_no" placeholder="+353" value="{{ old('email') }}" required autocomplete="mobile-no">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <input id="email" type="text" placeholder="email" class="form-control @error('email') is-invalid @enderror" name="username" value="{{ old('username') }}" required autocomplete="username">
